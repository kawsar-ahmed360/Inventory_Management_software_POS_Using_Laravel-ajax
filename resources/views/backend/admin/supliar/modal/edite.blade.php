...
<div id="Edite_supliar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="studenteditedataTitle" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header" style="text-align: center;" align="center">
                                                            <h5 class="" style="text-align: center;">Profile Supliar</h5>
                                                    ...
                                                    <form action="{{ route('supliarAjaxupdate') }}"  method="POST" id="EditeSupliar">
                                                      @csrf
